                ...
                <div class="block w-full overflow-x-auto">
                        ...
                        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                            <div class="block w-full overflow-x-auto p-2">
                                    ...
                                    <form action="{{ url('/especialist/store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                              ...
                                              <div class="grid gap-6 mb-6 md:grid-cols-2">
                                                  ...
                                                  <div>
                                                      ...
                                                      <input type="file" name="icon" id="icon" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                                  </div>
