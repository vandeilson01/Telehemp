             ...
             @endif
                ...
                <div class="rounded-t mb-0 px-4 py-3 border-0">
                  <div class="flex flex-wrap items-center">
                    ...
                    <a href="{{ url('categoria/create') }}" class="bg-transparent float-right hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                @foreach ($categorias as $categoria)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4">
                                            <form class="cateform flex" action="{{ route('categoria.destroy',$categoria->id) }}" method="POST">
                            
                                                <a class="font-medium text-blue-600 m-1 p-1 border border-blueth-800 rounded dark:text-blue-500 hover:text-blue-100" href="{{ route('categoria.show',$categoria->id) }}">
                                                ...
                                                <a class="font-medium text-blue-600 m-1 p-1 border border-blueth-800 rounded dark:text-blue-500 hover:text-blue-100" href="{{ route('categoria.edit',$categoria->id) }}">
                                                ...
                                                <button type="button" data-id="{{ $categoria->id }}" class="delete-ca font-medium text-blue-600 m-1 p-1 border border-blueth-800 rounded dark:text-blue-500 hover:text-blue-100">
